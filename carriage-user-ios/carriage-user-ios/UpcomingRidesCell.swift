...
class UpcomingRidesCell: UICollectionViewCell {
    ...
    override func layoutSubviews() {
        ...
        driverName.snp.makeConstraints { (make) -> Void in
            make.top.equalTo(driverProfile.snp.top)
            make.left.equalTo(driverProfile.snp.right).offset(20)
        }
        ...
        rideStatus.snp.makeConstraints { (make) -> Void in
            make.bottom.equalTo(driverName.snp.top).offset(-15)
            make.left.equalTo(driverProfile.snp.left)
                   }
        ...
        toLocation.snp.makeConstraints { (make) -> Void in
            make.bottom.equalTo(rideStatus.snp.top).offset(-20)
            make.left.equalTo(rideStatus.snp.left)
                   }
        ...
        toLabel.snp.makeConstraints { (make) -> Void in
            make.bottom.equalTo(toLocation.snp.top)
            make.left.equalTo(rideStatus.snp.left)
                   }
        ...
        fromLocation.snp.makeConstraints { (make) -> Void in
            make.bottom.equalTo(toLabel.snp.top).offset(-20)
            make.left.equalTo(rideStatus.snp.left)
                   }
        ...
        fromLabel.snp.makeConstraints { (make) -> Void in
            make.bottom.equalTo(fromLocation.snp.top)
            make.left.equalTo(rideStatus.snp.left)
                   }
        ...
        editButton.snp.makeConstraints { (make) -> Void in
            ...
            make.left.equalTo(rideTime.snp.right).offset(50)
